...
assert(runner.includes("postAppFinalization = $PostAppFinalizationPath"), "runner preflight should bind native exit to the first-route post-app finalization artifact");
