...
assert.strictEqual(summary.nativeBetaDistributionStatus, "distribution-evidence-waiting", "native rehearsal should wait on signing evidence before native beta distribution");
