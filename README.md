...
- Real cleanup command flow that combines scan, consent, selected scoped executor route, OpenAI recommendation follow-through, execution, and post-run rescan proof in one operator surface.
